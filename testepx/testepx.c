                              ...
                              void          *data)         // I - Callback data
{
  ...
  *system_name;           // System name, if any
  ...
  // System options
  static pappl_contact_t system_contact =    // Contact information
  {
    "Smith Kennedy",
    "epx-system@pwg.org",
    "+1-208-555-1212"
  ...
  static pappl_contact_t service_contact =    // printer-service-contact-col
  {
    "Smith Kennedy",
    "epx-printer-service@pwg.org",
    "+1-208-555-1212"
  };
  ...
  {
    papplSystemSetContact(system, &system_contact);
  ...
  if (NULL == firstPrinter)
  {
    ...
    // Set stuff in the printer (should be done here, not in the driver?)
    papplPrinterSetContact(firstPrinter, &contact);
    papplPrinterSetServiceContact(firstPrinter, &service_contact);
