...
typedef unsigned pappl_identify_actions_t;  // Bitfield for IPP "identify-actions" values
...
typedef unsigned short pappl_label_mode_t;  // Bitfield for IPP "label-mode-xxx" values
...
typedef unsigned short pappl_media_tracking_t;  // Bitfield for IPP "media-tracking" values
...
enum pappl_preason_e      // IPP "printer-state-reasons" bit values
{
  ...
  PAPPL_PREASON_IDENTIFY_PRINTER_REQUESTED  = 0x10000,  // 'identify-printer-requested'
...
struct pappl_pr_driver_data_s   // Printer driver data
{
  ...
  int     x_resolution[PAPPL_MAX_RESOLUTION]; // Horizontal printer resolutions
  int     y_resolution[PAPPL_MAX_RESOLUTION]; // Vertical printer resolutions
  ...
  pappl_media_col_t media_ready[PAPPL_MAX_SOURCE]; // Ready media
  int     num_source;   // Number of media sources (trays/rolls)
  const char    *source[PAPPL_MAX_SOURCE]; // Media sources
  int     left_offset_supported[2]; // media-left-offset-supported (0,0 for none)
  int     top_offset_supported[2]; // media-top-offset-supported (0,0 for none)
  pappl_media_tracking_t tracking_supported; // media-tracking-supported
  ...
  int     tear_offset_supported[2]; // label-tear-offset-supported (0,0 for none)
